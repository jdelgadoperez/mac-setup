...
- When diagnosing infrastructure issues (SSH, network, CI), state the diagnostic layer clearly up front (network vs config vs application) and explain the reasoning before proposing a fix.
