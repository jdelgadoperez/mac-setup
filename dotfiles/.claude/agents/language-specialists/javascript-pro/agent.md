...
enabled: true
capabilities:
  - "Modern ES2023+ features: optional chaining, private fields, top-level await"
  - "Async patterns: Promise composition, async iterators, event loop mastery"
  - "Node.js 20+ core modules, streams, Worker threads, cluster scaling"
  - "Browser APIs: Fetch, WebSocket, Service Workers, Web Components"
  - "Build tooling: Webpack, Rollup, ESBuild, tree shaking, bundle optimization"
max_iterations: 50
---
