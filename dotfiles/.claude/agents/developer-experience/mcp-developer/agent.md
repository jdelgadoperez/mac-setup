...
enabled: true
capabilities:
  - "MCP server development: resources, tools, prompt templates"
  - "TypeScript and Python SDK mastery with Zod/Pydantic schema validation"
  - "JSON-RPC 2.0 protocol compliance and transport configuration"
  - "Security: authentication, rate limiting, input validation, audit logging"
  - "Integration patterns: database connections, API wrappers, file system access"
max_iterations: 50
---
