...
echo -e "${PURPLE}🤖 [$MODEL_NAME]${RESET} 📁 ${GREEN}$DIR_NAME${RESET} ${YELLOW}💰 \$${COST_ROUNDED}${RESET} ${ORANGE}📝 ${COST_LINES}L${RESET} ${CYAN}🕐 ${DURATION_MIN}m${RESET} ${PINK}󰳏 $GIT_BRANCH $GIT_STATUS ${RESET}"
